...
import { Box, Button, Center, Heading, Text, useDisclosure, useToast, Spinner, Stack } from '@chakra-ui/react';
...
const SalesFunnel = () => {
  ...
  return (
    <Box h="calc(100vh - 100px)" display="flex" flexDirection="column">
      <Stack direction={{ base: 'column', md: 'row' }} mb={4} justify="space-between" align={{ base: 'start', md: 'center' }} spacing={4}>
        <Heading size="md">Funil de Vendas</Heading>
        <Button size={{ base: 'md', md: 'sm' }} w={{ base: 'full', md: 'auto' }} leftIcon={<SettingsIcon />} onClick={onOpen}>
          Configurar Etapas
        </Button>
      </Stack>
